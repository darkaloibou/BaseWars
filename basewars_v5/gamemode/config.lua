...
BaseWars.Config = {
	...
	Workshop    = "https://steamcommunity.com/sharedfiles/filedetails/?id=2591427687=",	-- Workshop: Link to your workshop download, accessed with /workshop
...
BaseWars.SpawnList.prop["Armor Dispensers"] = {
...
--                         Dispensers
------------------------------------------------------------------------
BaseWars.SpawnList.Dispenser["Armor Dispensers"] = {
	["Armor Dispenser V1"]				= BaseWars.GSL{Model = "models/props_combine/suit_charger001.mdl", Price = 1500, ClassName = "bw_dispenser_armor_v1",Limit = 1, Level = 5},
	["Armor Dispenser V2"]				= BaseWars.GSL{Model = "models/props_combine/suit_charger001.mdl", Price = 100000, ClassName = "bw_dispenser_armor_v2",Limit = 1, Level = 150},
	["Armor Dispenser V3"]				= BaseWars.GSL{Model = "models/props_combine/suit_charger001.mdl", Price = 40000000, ClassName = "bw_dispenser_armor_v3",Limit = 1, Level = 1100},
}
BaseWars.SpawnList.Dispenser["Health Dispensers"] = {
	["Health Dispenser V1"]				= BaseWars.GSL{Model = "models/props_spytech/supplystation.mdl", Price = 1000, ClassName = "bw_healthpad_v1",Limit = 1, Level = 5},
	["Health Dispenser V2"]				= BaseWars.GSL{Model = "models/props_spytech/supplystation.mdl", Price = 70000, ClassName = "bw_healthpad_v2",Limit = 1, Level = 200},
	["Health Dispenser V3"]				= BaseWars.GSL{Model = "models/props_spytech/supplystation.mdl", Price = 50000000, ClassName = "bw_healthpad_v3",Limit = 1, Level = 1200},
}
BaseWars.SpawnList.Dispenser["Ammo Dispensers"] = {
	["Ammo Dispenser V1"]				= BaseWars.GSL{Model = "models/tf2defaultmodels/artillerysentrystuff/woodbox.mdl", Price = 2000, ClassName = "bw_dispenser_ammo_v1",Limit = 1, Level = 5},
	["Ammo Dispenser V2"]				= BaseWars.GSL{Model = "models/tf2defaultmodels/artillerysentrystuff/woodbox.mdl", Price = 50000, ClassName = "bw_dispenser_ammo_v2",Limit = 1, Level = 300},
	["Ammo Dispenser V3"]				= BaseWars.GSL{Model = "models/tf2defaultmodels/artillerysentrystuff/woodbox.mdl", Price = 60000000, ClassName = "bw_dispenser_ammo_v3",Limit = 1, Level = 1500},
}
------------------------------------------------------------------------
--                         FUN
------------------------------------------------------------------------
...
BaseWars.SpawnList.farm["T01 - CrackerMaker"] = {
	...
	["Paper"] = BaseWars.GSL{Model = "models/zerochain/props_crackermaker/zcm_paper.mdl", Price = 500, ClassName = "zcm_paperroll" ,Limit = 3, Level = 15, ShouldFreeze = false}, 
	["BlackPowder"] = BaseWars.GSL{Model = "models/zerochain/props_crackermaker/zcm_blackpowder.mdl", Price = 500, ClassName = "zcm_blackpowder" ,Limit = 3, Level = 15, ShouldFreeze = false}, 
	["Box"] = BaseWars.GSL{Model = "models/zerochain/props_crackermaker/zcm_box.mdl", Price = 1500, ClassName = "zcm_box" ,Limit = 1, Level = 15, ShouldFreeze = false}, 
}
...
BaseWars.SpawnList.farm["T01 - Meth Lab"] = {
	...
	["Methylamin"] = BaseWars.GSL{Model = "models/zerochain/zmlab/zmlab_methylamin.mdl", Price = 2000, ClassName = "zmlab_methylamin" ,Limit = 3, Level = 40, ShouldFreeze = false},
	["Transport Crate"] = BaseWars.GSL{Model = "models/zerochain/zmlab/zmlab_transportcrate.mdl", Price = 1000, ClassName = "zmlab_collectcrate" ,Limit = 3, Level = 40, ShouldFreeze = false},
}
...
BaseWars.SpawnList.farm["T03 - Cigarette Factory"] = { 
	...
	["Engine Upgrade"] = BaseWars.GSL{Model = "models/maxofs2d/thruster_propeller.mdl", Price = 500000, ClassName = "cf_engine_upgrade" ,Limit = 1, Level = 170, ShouldFreeze = false},  
	["Storeage Upgrade"] = BaseWars.GSL{Model = "models/thrusters/jetpack.mdl", Price = 50000, ClassName = "cf_storage_upgrade" ,Limit = 1, Level = 170, ShouldFreeze = false},  
	["Export Box"] = BaseWars.GSL{Model = "models/props_junk/cardboard_box003a.mdl", Price = 250000, ClassName = "cf_delievery_box" ,Limit = 2, Level = 170, ShouldFreeze = false},  
	["Tabacco Pack"] = BaseWars.GSL{Model = "models/cigarette_factory/cf_tobacco_pack.mdl", Price = 100000, ClassName = "cf_tobacco_pack" ,Limit = 3, Level = 170, ShouldFreeze = false}, 
	["Paper"] = BaseWars.GSL{Model = "models/cigarette_factory/cf_rollpaper.mdl", Price = 50000, ClassName = "cf_roll_paper" ,Limit = 3, Level = 170, ShouldFreeze = false},  
...
BaseWars.SpawnList.farm["T05 - Yeast Beast"] = { 
	["Cold Water"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_water.mdl", Price = 10000000, ClassName = "zyb_water" ,Limit = 3, Level = 1200, ShouldFreeze = false},
	...
	["Distillery"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_distillery_heater.mdl", Price = 200000000, ClassName = "zyb_distillery" ,Limit = 1, Level = 1200}, 
	...
	["Fermentation Barrel"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_barrel.mdl", Price = 200000000, ClassName = "zyb_fermbarrel" ,Limit = 3, Level = 1200, ShouldFreeze = false}, 
	["Grinder"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_grinder.mdl", Price = 4000000, ClassName = "zyb_yeastgrinder" ,Limit = 2, Level = 1200}, 
	...
	["Jar Create"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_jarcrate.mdl", Price = 60000000, ClassName = "zyb_jarcrate" ,Limit = 2, Level = 1200, ShouldFreeze = false}, 
	["Jar Pack"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_jarpack.mdl", Price = 15000000, ClassName = "zyb_jarpack" ,Limit = 3, Level = 1200, ShouldFreeze = false}, 
	["Paper bag"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_paperbag.mdl", Price = 5000000, ClassName = "zyb_paperbag" ,Limit = 3, Level = 1200, ShouldFreeze = false}, 
	["Sugar"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_sugar.mdl", Price = 1000000, ClassName = "zyb_sugar" ,Limit = 3, Level = 1200, ShouldFreeze = false}, 
	["Wood"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_wood.mdl", Price = 2000000, ClassName = "zyb_fuel" ,Limit = 2, Level = 1200, ShouldFreeze = false}, 
	["Yeast"] = BaseWars.GSL{Model = "models/zerochain/props_yeastbeast/yb_yeast.mdl", Price = 1500000, ClassName = "zyb_yeast" ,Limit = 3, Level = 1200}, 
}

BaseWars.SpawnList.farm["T06 - Farm"] = { 
	["Carrot Seed"] = BaseWars.GSL{Model = "models/bluechu/bfarm/seed.mdl", Price = 10000000, ClassName = "bfarm_seed_carrot" ,Limit = 3, Level = 2100, ShouldFreeze = false},  
	["Lettuce Seed"] = BaseWars.GSL{Model = "models/bluechu/bfarm/seed.mdl", Price = 20000000, ClassName = "bfarm_seed_lettuce" ,Limit = 3, Level = 2100, ShouldFreeze = false},  
	["Small pot"] = BaseWars.GSL{Model = "models/bluechu/bfarm/pot_01.mdl", Price = 500000000, ClassName = "bfarm_pot_01" ,Limit = 4, Level = 2100},  
	["Big pot"] = BaseWars.GSL{Model = "models/bluechu/bfarm/pot_04.mdl", Price = 1000000000, ClassName = "bfarm_pot_04" ,Limit = 4, Level = 2100},  
	["Potato Seed"] = BaseWars.GSL{Model = "models/bluechu/bfarm/seed.mdl", Price = 30000000, ClassName = "bfarm_seed_potato" ,Limit = 3, Level = 2100, ShouldFreeze = false},  
	...
	["Soil Bag"] = BaseWars.GSL{Model = "models/bluechu/bfarm/bagdirt.mdl", Price = 20000000, ClassName = "bfarm_soil_bag" ,Limit = 1, Level = 2100, ShouldFreeze = false},  
	["Water Can"] = BaseWars.GSL{Model = "models/bluechu/bfarm/watercan.mdl", Price = 10000000, ClassName = "bfarm_water_can" ,Limit = 1, Level = 2100, ShouldFreeze = false},  

}
BaseWars.SpawnList.farm["T07 - Pharmaticals"] = { 
	["Guide Book"] = BaseWars.GSL{Model = "models/blues_pharm/book.mdl", Price = 50000000, ClassName = "bp_guide_book" ,Limit = 1, Level = 3000},  
	["Beaker"] = BaseWars.GSL{Model = "models/blues_pharm/beaker.mdl", Price = 250000000, ClassName = "bp_beaker" ,Limit = 8, Level = 3000, ShouldFreeze = false},  
	["Bunsen Burner"] = BaseWars.GSL{Model = "models/blues_pharm/bunsen_burner.mdl", Price = 100000000, ClassName = "bp_bunsen_burner" ,Limit = 4, Level = 3000},  
	["Freezer"] = BaseWars.GSL{Model = "models/blues_pharm/freezer.mdl", Price = 5000000000, ClassName = "bp_freezer" ,Limit = 1, Level = 3000},  
	["Pill Press"] = BaseWars.GSL{Model = "models/blues_pharm/pill_presser.mdl", Price = 3000000000, ClassName = "bp_pill_press" ,Limit = 1, Level = 3000},  
	["Keto Acid"] = BaseWars.GSL{Model = "models/blues_pharm/jar_1.mdl", Price = 3000000, ClassName = "bp_chemical_keto_acid" ,Limit = 2, Level = 3000},  
	["Propionic Acid"] = BaseWars.GSL{Model = "models/blues_pharm/jar_2.mdl", Price = 2000000, ClassName = "bp_chemical_prop_acid" ,Limit = 2, Level = 3000},  
	["Salicylic Acid"] = BaseWars.GSL{Model = "models/blues_pharm/jar_2.mdl", Price = 1000000, ClassName = "bp_chemical_sali_acid" ,Limit = 2, Level = 3000},  
	["Methyltestosterone"] = BaseWars.GSL{Model = "models/blues_pharm/jar_3.mdl", Price = 5000000, ClassName = "bp_chemical_17alph" ,Limit = 2, Level = 3000},  
	["2-Napththol"] = BaseWars.GSL{Model = "models/blues_pharm/jar_3.mdl", Price = 6000000, ClassName = "bp_chemical_2nap" ,Limit = 2, Level = 3000},  
	["Progestorone"] = BaseWars.GSL{Model = "models/blues_pharm/jar_3.mdl", Price = 7000000, ClassName = "bp_chemical_prog" ,Limit = 2, Level = 3000},  
	["Acetone"] = BaseWars.GSL{Model = "models/blues_pharm/jar_3.mdl", Price = 9000000, ClassName = "bp_chemical_acet2" ,Limit = 2, Level = 3000},  
	["Acetic Anhydride"] = BaseWars.GSL{Model = "models/blues_pharm/jar_4.mdl", Price = 15000000, ClassName = "bp_chemical_acet" ,Limit = 2, Level = 3000},  
	["Selenium Dioxide"] = BaseWars.GSL{Model = "models/blues_pharm/jar_4.mdl", Price = 20000000, ClassName = "bp_chemical_sele" ,Limit = 2, Level = 3000},  
	["Deionized Water"] = BaseWars.GSL{Model = "models/blues_pharm/jar_5.mdl", Price = 25000000, ClassName = "bp_chemical_deio" ,Limit = 2, Level = 3000},  
	["Pill Market"] = BaseWars.GSL{Model = "models/Kleiner.mdl", Price = 2000000000, ClassName = "bp_pill_market" ,Limit = 1, Level = 3000},  
	
}

BaseWars.SpawnList.farm["T08 - Meth Lab Pro"] = { 
	["Automatic Ice Breaker"] = BaseWars.GSL{Model = "models/zerochain/props_methlab/zmlab2_autobreaker.mdl", Price = 1000000000, ClassName = "zmlab2_item_autobreaker" ,Limit = 1, Level = 3900},  
	["Create"] = BaseWars.GSL{Model = "models/zerochain/props_methlab/zmlab2_crate.mdl", Price = 500000000, ClassName = "zmlab2_item_crate" ,Limit = 1, Level = 3900, ShouldFreeze = false},  
	["Filler"] = BaseWars.GSL{Model = "models/zerochain/props_methlab/zmlab2_filler.mdl", Price = 5000000000, ClassName = "zmlab2_machine_filler" ,Limit = 1, Level = 3900},  
	["Filter"] = BaseWars.GSL{Model = "models/zerochain/props_methlab/zmlab2_filter.mdl", Price = 10000000000, ClassName = "zmlab2_machine_filter" ,Limit = 1, Level = 3900},  
	["Freezer"] = BaseWars.GSL{Model = "models/zerochain/props_methlab/zmlab2_frezzer.mdl", Price = 7000000000, ClassName = "zmlab2_machine_frezzer" ,Limit = 1, Level = 3900},  
	["Furnace"] = BaseWars.GSL{Model = "models/zerochain/props_methlab/zmlab2_furnance.mdl", Price = 4000000000, ClassName = "zmlab2_machine_furnace" ,Limit = 1, Level = 3900},  
	["Mixer"] = BaseWars.GSL{Model = "models/zerochain/props_methlab/zmlab2_mixer.mdl", Price = 2000000000, ClassName = "zmlab2_machine_mixer" ,Limit = 1, Level = 3900},  
	...
	["Acid"] = BaseWars.GSL{Model = "models/zerochain/props_methlab/zmlab2_acid.mdl", Price = 50000000, ClassName = "zmlab2_item_acid" ,Limit = 1, Level = 3900, ShouldFreeze = false},  
	["Methylamine"] = BaseWars.GSL{Model = "models/zerochain/props_methlab/zmlab2_methylamine.mdl", Price = 700000000, ClassName = "zmlab2_item_methylamine" ,Limit = 1, Level = 3900, ShouldFreeze = false},  
...
BaseWars.SpawnList.farm["T09 - Weed"] = {
	["Watering can"] = BaseWars.GSL{Gun = true,Model = "models/zerochain/props_weedfarm/zwf_wateringcan_vm.mdl", Price = 7000000000, ClassName = "zwf_wateringcan" ,Limit = 1, Level = 4800}, 
	["Cable"] = BaseWars.GSL{Gun = true,Model = "models/zerochain/props_weedfarm/zwf_cable_vm.mdl", Price = 8000000000, ClassName = "zwf_cable" ,Limit = 1, Level = 4800}, 
	["Shop tablet"] = BaseWars.GSL{Model = "models/zerochain/props_weedfarm/zwf_tablet_vm.mdl", Price = 9000000000, ClassName = "zwf_shoptablet" ,Limit = 1, Level = 4800}, 

}

BaseWars.SpawnList.farm["T10 - MasterCook"] = {  

	["Cookbook"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_cookbook.mdl", Price = 95000000000, ClassName = "zmc_cookbook" ,Limit = 1, Level = 5700}, 
	["Fridge"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_fridge.mdl", Price = 100000000000, ClassName = "zmc_fridge" ,Limit = 1, Level = 5700}, 
	["Garbagebin"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_garbagebin.mdl", Price = 5000000000, ClassName = "zmc_garbagepin" ,Limit = 1, Level = 5700}, 
	["Mixer"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_mixer.mdl", Price = 45000000000, ClassName = "zmc_mixer" ,Limit = 1, Level = 5700}, 
	["Worktable"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_worktable.mdl", Price = 85000000000, ClassName = "zmc_worktable" ,Limit = 1, Level = 5700}, 

	["Customer Table"] = BaseWars.GSL{Model = "models/props_c17/FurnitureTable001a.mdl", Price = 20000000000, ClassName = "zmc_customertable" ,Limit = 1, Level = 5700}, 
	["Order Table"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_ordertable.mdl", Price = 30000000000, ClassName = "zmc_ordertable" ,Limit = 1, Level = 5700}, 
	["Dish Table"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_dishtable.mdl", Price = 40000000000, ClassName = "zmc_dishtable" ,Limit = 1, Level = 5700}, 

	["BoilPot"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_heater.mdl", Price = 50000000000, ClassName = "zmc_boilpot" ,Limit = 1, Level = 5700}, 
	["Grill"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_heater.mdl", Price = 60000000000, ClassName = "zmc_grill" ,Limit = 1, Level = 5700}, 
	["Oven"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_heater.mdl", Price = 70000000000, ClassName = "zmc_oven" ,Limit = 1, Level = 5700}, 
	...
	["Gas"] = BaseWars.GSL{Model = "models/zerochain/props_kitchen/zmc_gastank.mdl", Price = 9000000000, ClassName = "zmc_gastank" ,Limit = 1, Level = 5700}, 
...
BaseWars.SpawnList.farm["T11 - Bitmineur"] = {
	...
	["Extention lead"] = BaseWars.GSL{Model = "models/bitminers2/bitminer_plug_3.mdl", Price = 1000000000, ClassName = "bm2_extention_lead" ,Limit = 1, Level = 6600, ShouldFreeze = false},
	["Fuel"] = BaseWars.GSL{Model = "models/props_junk/gascan001a.mdl", Price = 9000000000, ClassName = "bm2_fuel" ,Limit = 1, Level = 6600, ShouldFreeze = false},
	["Generator"] = BaseWars.GSL{Model = "models/bitminers2/generator.mdl", Price = 50000000000, ClassName = "bm2_generator" ,Limit = 1, Level = 6600},
	["Power Lead"] = BaseWars.GSL{Model = "models/bitminers2/bitminer_plug_1.mdl", Price = 2000000000, ClassName = "bm2_power_lead" ,Limit = 1, Level = 6600, ShouldFreeze = false},
}
...
--                         DEFENCE
------------------------------------------------------------------------
BaseWars.SpawnList.defense ["1 - Controllable Turret"] = {
	["Controllable Turret"] 		= BaseWars.GSL{Model = "models/props_combine/combine_barricade_short02a.mdl", Price = 7500, ClassName = "bw_turret_manual", Limit = 3, Level = 5},
}
BaseWars.SpawnList.defense ["2 - Ballistic Turret"] = {
	["Ballistic Turret T1"] 		= BaseWars.GSL{Model = "models/tf2defaultmodels/ledstuff/sentry_level1.mdl", Price = 2500, ClassName = "bw_turret_ballistic_t1", Limit = 1, Level = 30},
	["Ballistic Turret T2"] 		= BaseWars.GSL{Model = "models/tf2defaultmodels/ledstuff/sentry_level2.mdl", Price = 6000000, ClassName = "bw_turret_ballistic_t2", Limit = 1, Level = 150},
	["Ballistic Turret T3"] 		= BaseWars.GSL{Model = "models/tf2defaultmodels/ledstuff/sentry_level3.mdl", Price = 1000000000, ClassName = "bw_turret_ballistic_t3", Limit = 1, Level = 1000},
}
BaseWars.SpawnList.defense ["3 - Laser Turret"] = {
	["Laser Turret T1"] 			= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/turret_level1.mdl", Price = 1600000, ClassName = "bw_turret_laser_t1", Limit = 1, Level = 60},
	["Laser Turret T2"] 			= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/turret_level2.mdl", Price = 250000000, ClassName = "bw_turret_laser_t2", Limit = 1, Level = 250},
	["Laser Turret T3"] 			= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/turret_level3.mdl", Price = 10000000000, ClassName = "bw_turret_laser_t3", Limit = 1, Level = 2500},
}

BaseWars.SpawnList.defense ["4 - Canon Turret"] = {
	["Canon Turret T1"] 			= BaseWars.GSL{Model = "models/tf2defaultmodels/artillerysentrystuff/sentry_level1.mdl", Price = 2500000, ClassName = "bw_turret_cannon_t1", Limit = 1, Level = 90},
	["Canon Turret T2"] 			= BaseWars.GSL{Model = "models/tf2defaultmodels/artillerysentrystuff/sentry_level2.mdl", Price = 500000000, ClassName = "bw_turret_cannon_t2", Limit = 1, Level = 500},
	["Canon Turret T3"] 			= BaseWars.GSL{Model = "models/tf2defaultmodels/artillerysentrystuff/sentry_level3.mdl", Price = 20000000000, ClassName = "bw_turret_cannon_t3", Limit = 1, Level = 5000},
}
BaseWars.SpawnList.defense ["5 - Tesla"] = {
	["Tesla Coil"]					= BaseWars.GSL{Model = "models/teslacoil_mini/teslacoil_mini.mdl", Price = 250000000, ClassName = "bw_tesla", Limit = 1, Level = 2000},
}
...
--                         ENTITEES
------------------------------------------------------------------------
BaseWars.SpawnList.Entities["Printer Capacity"] = {
	["Capacity Upgrade V1"]		= BaseWars.GSL{Model = "models/livaco/advprinters2/livaco_repair.mdl", Price = 150, ClassName = "bw_capacity_v1",Limit = 3, Level = 15, ShouldFreeze = false},
	["Capacity Upgrade V2"]		= BaseWars.GSL{Model = "models/livaco/advprinters2/livaco_repair.mdl", Price = 9000, ClassName = "bw_capacity_v2",Limit = 3, Level = 90, ShouldFreeze = false},
	["Capacity Upgrade V3"]		= BaseWars.GSL{Model = "models/livaco/advprinters2/livaco_repair.mdl", Price = 21000, ClassName = "bw_capacity_v3",Limit = 3, Level = 210, ShouldFreeze = false},
	["Capacity Upgrade V4"]		= BaseWars.GSL{Model = "models/livaco/advprinters2/livaco_repair.mdl", Price = 60000, ClassName = "bw_capacity_v4",Limit = 3, Level = 600, ShouldFreeze = false},
	["Capacity Upgrade V5"]		= BaseWars.GSL{Model = "models/livaco/advprinters2/livaco_repair.mdl", Price = 140000, ClassName = "bw_capacity_v5",Limit = 3, Level = 1400, ShouldFreeze = false},
	["Capacity Upgrade V6"]		= BaseWars.GSL{Model = "models/livaco/advprinters2/livaco_repair.mdl", Price = 230000, ClassName = "bw_capacity_v6",Limit = 3, Level = 2300, ShouldFreeze = false},
	["Capacity Upgrade V7"]		= BaseWars.GSL{Model = "models/livaco/advprinters2/livaco_repair.mdl", Price = 320000, ClassName = "bw_capacity_v7",Limit = 3, Level = 3200, ShouldFreeze = false},
	["Capacity Upgrade V8"]		= BaseWars.GSL{Model = "models/livaco/advprinters2/livaco_repair.mdl", Price = 410000, ClassName = "bw_capacity_v8",Limit = 3, Level = 4100, ShouldFreeze = false},
}
BaseWars.SpawnList.Entities["Armour Kit"] = {
	["Armour Kit V1"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/toolbox.mdl", Price = 200, ClassName = "bw_armor_v1", ShouldFreeze = false, Level = 20},
	["Armour Kit V2"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/toolbox.mdl", Price = 10000, ClassName = "bw_armor_v2", ShouldFreeze = false, Level = 100},
	["Armour Kit V3"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/toolbox.mdl", Price = 230000, ClassName = "bw_armor_v3", ShouldFreeze = false, Level = 230},
	["Armour Kit V4"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/toolbox.mdl", Price = 650000, ClassName = "bw_armor_v4", ShouldFreeze = false, Level = 650},
	["Armour Kit V5"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/toolbox.mdl", Price = 1500000, ClassName = "bw_armor_v5", ShouldFreeze = false, Level = 1500},
	["Armour Kit V6"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/toolbox.mdl", Price = 2400000, ClassName = "bw_armor_v6", ShouldFreeze = false, Level = 2400},
	["Armour Kit V7"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/toolbox.mdl", Price = 3300000, ClassName = "bw_armor_v7", ShouldFreeze = false, Level = 3300},
	["Armour Kit V8"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/toolbox.mdl", Price = 22000000, ClassName = "bw_armor_v8", ShouldFreeze = false, Level = 4200},
}
BaseWars.SpawnList.Entities["Structures"] = {
	["Spawnpoint"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/prefortress2teleporter/teleporter_light.mdl", Price = 100, ClassName = "bw_spawnpoint", UseSpawnFunc = true},
	["Radar"]						= BaseWars.GSL{Model = "models/tf2defaultmodels/rayzarstuff/dispenser_level3_building.mdl", Price = 25000000, ClassName = "bw_radar",  Limit = 1, Level = 35, Level = 1500},
}
BaseWars.SpawnList.Entities["Consumables"] = {
	["Repair Kit"]					= BaseWars.GSL{Model = "models/tf2defaultmodels/skirmisherstuff/toolbox.mdl", Price = 50, ClassName = "bw_repairkit", ShouldFreeze = false},
	["Printer Paper"]				= BaseWars.GSL{Model = "models/livaco/advprinters2/livaco_ink.mdl", Price = 100, ClassName = "bw_printerpaper", ShouldFreeze = false},
}
