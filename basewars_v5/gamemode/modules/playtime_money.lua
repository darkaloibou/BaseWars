...
function MODULE:Paint()
	...
	draw.DrawText(playTime(plTime), tag .. ".Large", respW(450), respH(975), orange, TEXT_ALIGN_LEFT)
	draw.DrawText("Temps de jeu", tag .. ".Large", respW(322.5), respH(975), white, TEXT_ALIGN_LEFT)
