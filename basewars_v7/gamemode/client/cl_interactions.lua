...
LookEnt:RegisterEnt("bw_dispenser_ammo_v1", UseBind, function(aimEnt)
	return BaseWars.LANG.Use, "Armor Dispenser"
end,
function(aimEnt)
	return aimEnt:GetUsable() and color1 or color3, color2
end)
LookEnt:RegisterEnt("bw_dispenser_ammo_v2", UseBind, function(aimEnt)
	return BaseWars.LANG.Use, "Armor Dispenser"
end,
function(aimEnt)
	return aimEnt:GetUsable() and color1 or color3, color2
end)
LookEnt:RegisterEnt("bw_dispenser_ammo_v3", UseBind, function(aimEnt)
	return BaseWars.LANG.Use, "Armor Dispenser"
end,
function(aimEnt)
	return aimEnt:GetUsable() and color1 or color3, color2
...
LookEnt:RegisterEnt("bw_dispenser_armor_v1", UseBind, function(aimEnt)
	return BaseWars.LANG.Use, "Ammo Dispenser"
end,
function(aimEnt)
	return aimEnt:GetUsable() and color1 or color3, color2
end)
LookEnt:RegisterEnt("bw_dispenser_armor_v2", UseBind, function(aimEnt)
	return BaseWars.LANG.Use, "Ammo Dispenser"
end,
function(aimEnt)
	return aimEnt:GetUsable() and color1 or color3, color2
end)
LookEnt:RegisterEnt("bw_dispenser_armor_v3", UseBind, function(aimEnt)
	return BaseWars.LANG.Use, "Ammo Dispenser"
end,
function(aimEnt)
	return aimEnt:GetUsable() and color1 or color3, color2
