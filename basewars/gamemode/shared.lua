...
GM.Website 		= "https://chill.mtxserv.com"
GM.Credits		= [[
Just dark because he is the best
]]
GM.Copyright = [[
Copyright (c) 2023-2024 dark aloibou
]]
GM.Translators = [[dark is the best of all
]]
...
// Set the default props error image
local DefaultData = {
	__index = {
...
// Récupère l'info si il est raidable
...
// Sauvegarde les donnée en dossier.txt ? Il faut vraiment que je le passe en sql
...
// Fait partie du chat du mode mais sert arien
...
// Crée un joueur en non faction
local PlayersCol = Color(125, 125, 125, 255)
team.SetUp(1, "No Faction", PlayersCol)

// Une fonction pour éviter le noclip en raid ? Useless x100
...
// Block les intéraction avec le physic gun
...
// Je sais pas mais je pense que ca pue
...
// Bloque le freeze via le r je pense
...
// Aussi utile que d'avoir un compteur de pas
--[[local stupidStuff = {
	["precision"] = true,
	["inflator"] = true,
	["paint"] = true,
