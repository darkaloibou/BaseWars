...
ENT.Capacity 		= 260000000 --Il n'y a pas de limite vous pouvez mettre la capacité de votre choix !
ENT.Money 			= 0
ENT.MaxPaper		= 0
ENT.PrintInterval 	= 1
ENT.PrintAmount		= 3
	...
	if CLIENT then
		...
		function ENT:DrawDisplay(pos, ang, scale)
			...
			if not Pw then
				...
				draw.DrawText(self.PrintName, "banksss", w / 2-220, 700, Color(0,255,255, 255), TEXT_ALIGN_CENTER)
				draw.DrawText("Génerateur requis !", "banksss", w - 4-430, 100+620, Color(0,255,255), TEXT_ALIGN_CENTER)

      return end

			if disabled then

				draw.DrawText(BaseWars.LANG.PrinterBeen, "banksss", w / 2, h / 2 - 48, Color(0,255,255, 255), TEXT_ALIGN_CENTER)
				draw.DrawText(BaseWars.LANG.Disabled, "banksss", w / 2, h / 2 - 32, Color(0,255,255), TEXT_ALIGN_CENTER)
			...
			if cap > 0 and cap ~= math.huge then
				...
				drawCircle(0, 900, 180, 100, (money / cap) * 360, 400, Color(0,255,255, 255))
				drawCircle(0, 900, 180, 100, 360, 300, Color(0, 0, 0))
				draw.DrawText(currentMoney.. " / " .. BaseWars.LANG.CURRENCY .. BaseWars.NumberFormat(cap), font, 0, ("banksss" and 106 or 105 + fh / 4)+785, Color(0,255,255, 255), TEXT_ALIGN_CENTER)
				draw.DrawText(self.PrintName, "banksss", 0, 800, Color(0,255,255, 255), TEXT_ALIGN_CENTER)
				draw.DrawText(moneyPercentage .. "%" , "banksss",	0, 71 + 780, Color(0,255,255, 255), TEXT_ALIGN_CENTER)
